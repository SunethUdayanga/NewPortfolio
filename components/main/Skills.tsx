...
export default function Skills() {
  return (
    <div>
      ...
      <section id='skills' className='flex flex-col bg-gray-900 rounded-3xl items-center justify-center gap-5 h-full relative overflow-hidden py-4 px-4' style={{ transform: 'scale(0.9)' }}>
        <div>
          <SkillText />
        </div>
