                ...
                <div className="basis-2/3 h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
                  ...
                  Mobile, and Software development. Check out my projects and skills. */}
                    ...
                    <motion.a
                        ...
                        className="inline-flex sm:w-full m-6 md:w-1/3 h-12 animate-shimmer items-center justify-center rounded-3xl border border-slate-500 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
